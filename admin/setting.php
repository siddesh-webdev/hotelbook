            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" onclick="site_title.value = general_data.title, site_about.value = general_data.about" class="btn btn-secondary shadow-none" data-bs-dismiss="modal" >Cancel</button>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                         <label class="form-label fw-bold">Phone Numbers (with country code)</label>
                          ...
                          <div class="input-group mb-3">
                            <span class="input-group-text" ><i class="bi bi-telephone-fill"></i></span>
                            <input type="number" name="pn1" id="pn2_inp" class="form-control shadow-none" required>
                          </div>
                        </div> 
                        <div class="mb-3">
