...
<head>
   ...
   include("link.php");
   ?>
   <title><?php echo $setting_r['title'] ?> - Home</title>
    <link
    rel="stylesheet"
  ...
  <div class="container-fluid px-lg-4 mt-4">
    ...
    <div class="container availability-form">
      <div class="row">
        <div class="col-lg-12 bg-white shadow p-4 rounded">
          <h5 class="mb-4">Check Availabilities</h5>
          <form action="rooms.php">
              <div class="row align-items-end">
                ...
                <select class="form-select shadow-none" name="adult">
                    <?php
                     $guests_q=mysqli_query($cn,"SELECT MAX(adult) AS `max_adult`, MAX(children) AS `max_children` FROM `rooms` WHERE `status`='1' AND `removed`='0'");
        ...
        <div class="row">
              ...
              <?php
                ...
                while($room_data =mysqli_fetch_assoc($room_res))
                {
                  ...
                  $fea_q = mysqli_query($cn,"SELECT f.name FROM `features` f 
                  ...
                  $features_data="";
                    ...
                    $fac_q= mysqli_query($cn,"SELECT f.name FROM `facilities` f 
                    ...
                    $thumb_q = mysqli_query($cn,"SELECT * FROM `room_images` 
                    ...
                    $rating_res= mysqli_query($cn,$rating_q);
                    ...
                    if($rating_fetch['avg_rating']!=NULL)
                    {
                      ...
                      $rating_data="<div class='rating mb-4'>
                        ...
                        <span class='bagde rounded-pill bg-light'>
                        ";
    ...
    <div class="container">
      <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
          <?php
              $res= mysqli_query($cn,"SELECT * FROM `facilities` ORDER BY `id` DESC LIMIT 5");
    ...
    <div class="container mt-5">
      <div class="swiper swiper-test">
          <div class="swiper-wrapper mb-5">
            ...
            $review_res = mysqli_query($cn,$review_q);
    ...
    <div class="container">
      <div class="row">
          <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
              <iframe class="w-100" height="320px" src="<?php echo $contact_r['iframe'] ?>" loading="lazy"></iframe>
          </div>
          ...
          <div class="bg-white p-4 rounded mb-4">
              ...
              <br> <a href="tel: +<?php echo $contact_r['pn2'] ?>" class="d-inline-block text-decoration-none text-dark"><i class="bi bi-telephone-fill"></i> +<?php echo $contact_r['pn2'] ?></a>
          </div>
          <div class="bg-white p-4 rounded mb-4">
              <h5>Follow Us</h5>
              ...
              <br>  <a href="<?php echo $contact_r['fb'] ?>" class="d-inline-block mb-3 ">
              <span class="badge bg-light text-dark fs-6 p-2">
