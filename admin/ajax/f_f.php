<?php
   ...
   if(isset($_POST['add_feature']))
    ...
    if(isset($_POST['get_features']))
    {
      ...
      <td>$row[name]</td>
      <td>
        <button type="button" class="btn btn-danger shadow-none" onclick="rem_feature($row[id])">
    ...
    if(isset($_POST['get_facilities']))
    {
      ...
      <td>
        <button type="button" class="btn btn-danger shadow-none" onclick="rem_facility($row[id])">
          <i class="bi bi-trash"></i> Delete
        </button> 
      </td>
      </tr>
