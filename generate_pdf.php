...
use Dompdf\Dompdf;
  ...
  include("admin/dompdf/vendor/autoload.php");
   ...
   if(!(isset($_SESSION['login']) && $_SESSION['login']==true))
   {
    ...
    if(isset($_GET['gen_pdf']) && isset($_GET['id']))
    {
     ...
     <table border='1'>
      ...
      <tr>
      <td>Contact : $data[phonenum]</td>
      <td>Address: $data[address]</td>
      </tr>
      <tr>
      <td>Room Name : $data[room_name]</td>
      <td>Cost: $data[price] Rs. per night</td>
      </tr>
      <tr>
     ...
     if($data['booking_status']=='cancelled')
     {
        ...
        $table_data.="<tr>
         <td>Amount Paid: $data[trans_amount] Rs.</td>
         <td>Refund: $refund</td>
        </tr>";
    ...
    {
      $table_data.="<tr>
        <td>Transaction Amount: $data[trans_amt] Rs.</td>
      ...
      $table_data.="<tr>
        ...
        <td>Amount Paid: $data[trans_amt] Rs.</td>
      </tr>";
    ...
    $dompdf->stream($data['order_id'].".pdf");
