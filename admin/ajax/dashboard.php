<?php
  ...
  if(isset($_POST['booking_analytics']))
  {
    ...
    $result = mysqli_fetch_assoc(mysqli_query($cn,"SELECT 
  ...
  if(isset($_POST['user_analytics']))
  {
    ...
    $total_reviews =mysqli_fetch_assoc(mysqli_query($cn,"SELECT COUNT(id) AS `count` FROM `rating_review` $condition"));

    $total_queries =mysqli_fetch_assoc(mysqli_query($cn,"SELECT COUNT(id) AS `count` FROM `user_queries` $condition"));

    $total_new_reg =mysqli_fetch_assoc(mysqli_query($cn,"SELECT COUNT(id) AS `count` FROM `user_cred` $condition"));
