...
<html lang="en">
   <head>
      ...
      <?php
         include("link.php");
         ?>
      <title><?php echo $setting_r['title'] ?> - Profile</title>
   </head>
<body class="bg-light">
   <?php
    include("header.php");
               ...
               <div class="col-12 mb-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                  <form id="info-form">
                     ...
                     <button type="submit" class="btn text-white custom-bg shodow-none">Save Changes </button> 
                  </form>
                </div>
               </div>
                ...
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                  <form id="profile-form">
                     ...
                     <img src="<?php echo USERS_IMG_PATH.$u_fetch['profile']?>" class="rounded-circle img-fluid">
                        <label class="mt-3 form-label fw-bold">New Picture</label>
     ...
     let xhr = new XMLHttpRequest();
      ...
      xhr.onload = function(){ 
         ...
         else if(this.responseText == 'upd_failed')
         {
            ...
            alert('success',"Profile Picture Changed.!" );
         }
